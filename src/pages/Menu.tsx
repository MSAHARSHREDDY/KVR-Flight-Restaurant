      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <Reveal delay={0.2} className="flex flex-wrap justify-center gap-4 mb-16">
          <button
            ...
            className={cn(
              "px-6 py-2 rounded-full border text-sm uppercase tracking-wider transition-all",
              activeCategory === "all"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {items?.map((item: any, i: number) => (
              <Reveal key={item.id} delay={i * 0.1}>
                <div className="relative group p-[1px] rounded-[17px] h-full overflow-hidden cursor-pointer">
                  ...
                  <div className="relative bg-dark-900/95 backdrop-blur-3xl rounded-2xl overflow-hidden flex flex-col h-full z-10 transition-transform duration-500 group-hover:-translate-y-1 shadow-2xl group-hover:shadow-[0_0_30px_rgba(245,158,11,0.15)]">
                    ...
                    <div className="p-6 flex flex-col flex-grow relative z-30">
                      <div className="flex justify-between items-start mb-3">
                        <h3 className="heading-serif text-xl text-white group-hover:text-gold-400 transition-colors">{item.name}</h3>
                      ...
                      <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/10 relative">
                        ...
                        <button className="text-gold-500 text-sm tracking-widest uppercase font-semibold hover:text-white transition-colors flex items-center gap-2 group-hover:gap-3">
                          <span>Add</span>
